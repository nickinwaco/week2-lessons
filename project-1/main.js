...
document.getElementById("q1").innerHTML = "<p> array1 = " + array1 + "</p>";
...
document.getElementById("q2").innerHTML = "<p> array1 = " + array1 + "</p>";
...
document.getElementById("q3").innerHTML = "<p> array1 = " + array1 + "</p>";


// 4. Add two new items after the second item.

array1.splice(1,1, 8,9);

document.getElementById("q4").innerHTML = "<p> array1 = " + array1 + "</p>";
...
//document.getElementById("q5").innerHTML = "<p> array1 = " + array1 + "</p>";
document.getElementById("q5").innerHTML = array1.length;
...
things[2]='keyboard';
document.getElementById("q6").innerHTML = "<p> things array = " + things + "</p>";
...
things.join();
document.getElementById("q7").innerHTML = "<p> things array = " + things + "</p>";
